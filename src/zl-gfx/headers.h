...
enum {
	...
	ZGL_FRAMEBUFFER_STATUS_INCOMPLETE_ATTACHMENT,
	ZGL_FRAMEBUFFER_STATUS_INCOMPLETE_MISSING_ATTACHMENT,
	ZGL_FRAMEBUFFER_STATUS_INCOMPLETE_DRAW_BUFFER,
	ZGL_FRAMEBUFFER_STATUS_INCOMPLETE_READ_BUFFER,
	ZGL_FRAMEBUFFER_STATUS_UNSUPPORTED,
	ZGL_FRAMEBUFFER_STATUS_INCOMPLETE_MULTISAMPLE,
	ZGL_FRAMEBUFFER_STATUS_INCOMPLETE_LAYER_TARGETS_ARB,
	ZGL_FRAMEBUFFER_STATUS_INCOMPLETE_LAYER_COUNT_ARB,
	ZGL_FRAMEBUFFER_STATUS_INCOMPLETE_DIMENSIONS,
	ZGL_FRAMEBUFFER_STATUS_INCOMPLETE_FORMATS,
...
extern void		zglBufferSubData				( u32 target, u32 start, u32 size, const void* data );
