...
u32 zglMapFromGLEnum( u32 glEnum ) {
	switch ( glEnum ) {
		...
		case GL_FRAMEBUFFER_COMPLETE:						return ZGL_FRAMEBUFFER_STATUS_COMPLETE;
		case GL_FRAMEBUFFER_INCOMPLETE_ATTACHMENT:			return ZGL_FRAMEBUFFER_STATUS_INCOMPLETE_ATTACHMENT;
		case GL_FRAMEBUFFER_INCOMPLETE_MISSING_ATTACHMENT:	return ZGL_FRAMEBUFFER_STATUS_INCOMPLETE_MISSING_ATTACHMENT;
		case GL_FRAMEBUFFER_UNSUPPORTED:					return ZGL_FRAMEBUFFER_STATUS_UNSUPPORTED;

#if defined ( MOAI_OS_NACL ) || defined ( MOAI_OS_IPHONE ) || defined ( MOAI_OS_ANDROID ) || defined ( MOAI_OS_HTML ) // GL ES
		case GL_FRAMEBUFFER_INCOMPLETE_DIMENSIONS:			return ZGL_FRAMEBUFFER_STATUS_INCOMPLETE_DIMENSIONS;
#else
		case GL_FRAMEBUFFER_INCOMPLETE_DRAW_BUFFER:			return ZGL_FRAMEBUFFER_STATUS_INCOMPLETE_DRAW_BUFFER;
		case GL_FRAMEBUFFER_INCOMPLETE_READ_BUFFER:			return ZGL_FRAMEBUFFER_STATUS_INCOMPLETE_READ_BUFFER;
		case GL_FRAMEBUFFER_INCOMPLETE_MULTISAMPLE:			return ZGL_FRAMEBUFFER_STATUS_INCOMPLETE_MULTISAMPLE;
		case GL_FRAMEBUFFER_INCOMPLETE_LAYER_TARGETS_ARB:	return ZGL_FRAMEBUFFER_STATUS_INCOMPLETE_LAYER_TARGETS_ARB;
		case GL_FRAMEBUFFER_INCOMPLETE_LAYER_COUNT_ARB:		return ZGL_FRAMEBUFFER_STATUS_INCOMPLETE_LAYER_COUNT_ARB;
		case GL_FRAMEBUFFER_INCOMPLETE_DIMENSIONS_EXT:		return ZGL_FRAMEBUFFER_STATUS_INCOMPLETE_DIMENSIONS;
		case GL_FRAMEBUFFER_INCOMPLETE_FORMATS_EXT:			return ZGL_FRAMEBUFFER_STATUS_INCOMPLETE_FORMATS;
#endif
	};
	assert ( false );
	return 0;
...
u32 zglCheckFramebufferStatus ( u32 target ) {
	...
	return zglMapFromGLEnum(status);
}
