...
void MOAIFrameBufferTexture::OnCreate () {
	...
	if ( status == ZGL_FRAMEBUFFER_STATUS_COMPLETE ) {
		...
		cc8* statusString;
		switch ( status ) {
			case ZGL_FRAMEBUFFER_STATUS_INCOMPLETE_ATTACHMENT:
				statusString = "ZGL_FRAMEBUFFER_STATUS_INCOMPLETE_ATTACHMENT"; break;
			case ZGL_FRAMEBUFFER_STATUS_INCOMPLETE_DRAW_BUFFER:
				statusString = "ZGL_FRAMEBUFFER_STATUS_INCOMPLETE_DRAW_BUFFER"; break;
			case ZGL_FRAMEBUFFER_STATUS_INCOMPLETE_MISSING_ATTACHMENT:
				statusString = "ZGL_FRAMEBUFFER_STATUS_INCOMPLETE_MISSING_ATTACHMENT"; break;
			case ZGL_FRAMEBUFFER_STATUS_INCOMPLETE_READ_BUFFER:
				statusString = "ZGL_FRAMEBUFFER_STATUS_INCOMPLETE_READ_BUFFER"; break;
			case ZGL_FRAMEBUFFER_STATUS_UNSUPPORTED:
				statusString = "ZGL_FRAMEBUFFER_STATUS_UNSUPPORTED"; break;
			case ZGL_FRAMEBUFFER_STATUS_INCOMPLETE_MULTISAMPLE:
				statusString = "ZGL_FRAMEBUFFER_STATUS_INCOMPLETE_MULTISAMPLE"; break;
			case ZGL_FRAMEBUFFER_STATUS_INCOMPLETE_LAYER_TARGETS_ARB:
				statusString = "ZGL_FRAMEBUFFER_STATUS_INCOMPLETE_LAYER_TARGETS_ARB"; break;
			case ZGL_FRAMEBUFFER_STATUS_INCOMPLETE_LAYER_COUNT_ARB:
				statusString = "ZGL_FRAMEBUFFER_STATUS_INCOMPLETE_LAYER_COUNT_ARB"; break;
			case ZGL_FRAMEBUFFER_STATUS_INCOMPLETE_DIMENSIONS:
				statusString = "ZGL_FRAMEBUFFER_STATUS_INCOMPLETE_DIMENSIONS"; break;
			case ZGL_FRAMEBUFFER_STATUS_INCOMPLETE_FORMATS:
				statusString = "ZGL_FRAMEBUFFER_STATUS_INCOMPLETE_FORMATS"; break;
			default:
				statusString = "Unknown GL enum"; break;
		}
		MOAIPrint("Failed to create frame buffer texture, status enum: %s", statusString);
		this->Clear ();
	}
}
